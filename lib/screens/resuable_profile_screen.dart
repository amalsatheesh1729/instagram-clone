...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  getdata() async {
    try {
      //user
      DocumentSnapshot<Map<String, dynamic>> documentSnapshotsnapshot = await FirebaseFirestore
          .instance
          .collection('users')
          .doc(widget.uid)
          .get();
      ...
      //post
      QuerySnapshot<Map<String, dynamic>> querySnapshot = await FirebaseFirestore.instance.collection('posts').where('uid',isEqualTo: docsnap['uid']).get();
      postcount=querySnapshot.docs.length;
      following=docsnap['following'].length;
      followers=docsnap['followers'].length;
      isfollowing=docsnap['followers'].contains(FirebaseAuth.instance.currentUser!.uid);
      print(isfollowing);
      isloading=false;
      setState(() {});
    } catch (e) {
      showasnackbar(context, e.toString());
    }
  }
        ...
        body: ListView(
          ...
          children: [
                          ...
                          Row(
                            ...
                            children: [
                             ...
                             FollowButton(
                                  ...
                                  fun: () async {
                                   await FirebaseFireStoreStorage().signout();
                                 ...
                                 fun:() async{
                                   await  FirebaseFireStoreStorage().followuser(
            ...
            FutureBuilder(
                ...
                builder:(BuildContext context,AsyncSnapshot<QuerySnapshot<Map<String,dynamic>>> qsnap)
                {
                  if(!qsnap.hasData)
                    {
                  ...
                  {
                    return Container(
                      child: Image(image:NetworkImage(qsnap.data!.docs[index]['postPhotoURL']),fit: BoxFit.cover, ),
                    );
                  });
                }
            )
